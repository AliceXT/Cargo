...
<script type="text/javascript">
  ...
  function successTo(r){
    ...
    window.location.assign("/cargo/supply.php/Home/Admin/index/id/"+r.responseText());
  }
</script>-->
...
<div id="login-wrapper" class="png_bg">
  ...
  <div id="login-content">
    ...
    <form method="post" id="login_form" action="/cargo/supply.php/Home/Index/makePost">
      ...
      <p>
        ...
        <img style="height: 60%; width: 60%;" src="/cargo/supply.php/Home/Admin/showVerify" onclick="">
      </p>
      <p>
