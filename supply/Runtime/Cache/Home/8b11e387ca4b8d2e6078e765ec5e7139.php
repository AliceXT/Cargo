...
<script type="text/javascript">
  ...
  window.onload = function(){
    ...
    /****************下面是导航菜单的js代码****************/
    var url = "/cargo/supply.php/Home/Order/check";
    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <form action="/cargo/supply.php/Home/Order/delete" method="post">
          <table>
            <thead>
              <tr>
                <th>
            ...
            <tbody>
              <?php if(is_array($requests)): $i = 0; $__LIST__ = $requests;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$request): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($request['book_time']); ?></td>
                <td><?php echo ($request['result']); ?></td>
                <td><?php echo ($request['car']['id']); ?></td>
                <td><?php echo ($request['buyer']['name']); ?></td>
                <td><?php echo ($request['buyer']['telephone']); ?></td>
                <td><?php echo ($request['buyer']['Email']); ?></td>
                <td><?php echo ($request['buyer']['city']); ?></td>
                <td>
                  <!-- Icons -->
                  <a href=<?="/cargo/supply.php/Home/Order/modify/id/".$request['id']."/result/".$request['result']?> title="Edit"><img src="/cargo/admin/Home/Common/resources/images/icons/pencil.png" alt="Edit" /></a>
