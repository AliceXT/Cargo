...
<div id="login-wrapper" class="png_bg">
  <div id="login-top">
    <h1>Simpla Admin</h1>
    <!-- Logo (221px width) -->
    <a href="http://www.865171.cn"><img id="logo" src="/cyc2.8/admin/Home/Common/resources/images/logo.png" alt="Simpla Admin logo" /></a> </div>
  <!-- End #logn-top -->
  <div id="login-content">
    <form action="/cyc2.8/admin.php/Home/Admin/login" method="post" >
      ...
      <p>
        ...
        <img style="height: 60%; width: 60%;" src="/cyc2.8/admin.php/Home/Admin/showVerify" onclick="">
      </p>
      <p>
