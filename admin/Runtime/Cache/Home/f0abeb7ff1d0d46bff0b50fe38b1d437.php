...
<script type="text/javascript">
  ...
  window.onload = function(){
    ...
    /****************下面是导航菜单的js代码****************/
    var url = "/cargo/admin.php/Home/Car/search";
  ...
  <div id="main-content">
    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
        ...
        <form id="search_form" action="/cargo/admin.php/Home/Car/search" method="get">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <form action="/cargo/admin.php/Home/Car/delete" method="post">
          <table>
            <thead>
              <tr>
                <th>
            ...
            <tbody>
              <?php if(is_array($requests)): $i = 0; $__LIST__ = $requests;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$request): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                  <!-- Icons -->
                  <a href=<?="/cargo/admin.php/Home/Car/delete/id/".$request['id'];?> title="Delete"><img src="/cargo/admin/Home/Common/resources/images/icons/cross.png" alt="Delete"></a></td>
