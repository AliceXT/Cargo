...
},push:function(){var a=this.previous.apply(this,arguments);if(this.options.zebra){this.updateZebras();}return a;}});(function(){var b=null,a={},d={};var c=function(f){if(instanceOf(f,e.Set)){return f;
...
(function(){
    if( window.$G==null){  
        Window.implement('$G',function(g){
                    var _g=null;switch(g){case'x1':_g='一年级';break;case'x2':_g='二年级';break;case'x3':_g='三年级';break;case'x4':_g='四年级';break;case'x5':_g='五年级';break;case'x6':_g='六年级';break;case'c1':_g='七年级';break;case'c2':_g='八年级';break;case'c3':_g='九年级';break;case'g1':_g='高一';break;case'g2':_g='高二';break;case'g3':_g='高三';break;case'x':_g='小学';break;case'c':_g='初中';break;case'g':_g='高中';break;default:break;}return _g;})}                
    if(window.$S==null){Window.implement('$S',function(s){var _s=null;switch(s){case'01':_s='语文';break;case'02':_s='数学';break;case'03':_s='英语';break;case'04':_s='物理';break;case'05':_s='化学';break;case'06':_s='地理';break;case'07':_s='历史';break;case'08':_s='政治';break;case'09':_s='生物';break;}return _s;})}
})()
