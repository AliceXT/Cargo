...
<div class="contain"><!--主体容器-->
  <div class="container_left"> <!--左部内容-->
      ...
      <form id="search_form" action="/cargo/index.php/Home/Car/search" method="get">
          <input type="text" placeholder="关键词搜索" id="key" name="key" value=""><br>
           <select name="brand">
               ...
               <option value="5">阿斯顿·马丁</option>
               <option value="6">宝马</option>
               <option value="7">本田</option>
               <option value="8">别克</option>
           </select>
           <select name="city">
    ...
    <div class="cars">
      <?php $j = 0;?>
       <form id="search_form" action="/cargo/index.php/Home/Main/index" method="post">
        <?php if(is_array($requests)): $i = 0; $__LIST__ = $requests;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$request): $mod = ($i % 2 );++$i;?><div class="car_body">
            <div class='navbar navbar-inverse'>
              <div class='nav-collapse'>
                <div class="car_image">
                    <a href="#" target="_blank"><?php echo ($request['picture']); ?></a></li>
                </div>
                <div class="right"><?php echo ($request['id']); ?>
                    <h3><?php echo ($request['description']); ?></h3>
                    <p>车源所在地：四川- 成都市</p>
                    <p>限量：<strong><?php echo ($request['stock']); ?></strong></p>
                    <p>咨询电话：<strong>400-8888-888</strong></p>
                    <p><del>参考价：&yen;<?php echo ($request['price']); ?></del></p>
                    <p>限时特价：&yen;<strong>480,000</strong></p>
                    <span><button type="submit" class="btn btn-primary btn-lg" id="order<?=$j++;?>">我要买</button></span>
  ...
  <div class="container_right">
    <form action="/cargo/index.php/Home/Main/makePost" method="post">
      <div class="login"> 
        <!--<h3>用户登录</h3>             
        <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>                    
                    ...
                    <td>
                    <input type="password" id="password" onchange="" pattern="^[a-z A-Z 0-9 _]{8}" required/>
                    </td>
                </tr>            
            </table>
            </br>
...
<script type="text/javascript">
      ...
      for (var i = 0; i < 5; i++) {
        ...
        TINY.box.show('order.html',1,400,350,1)
        }//弹出填写购车需求的窗口
      };     
</script>
